        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-4 text-end mb-3">
                    <a href="{{ route('admin-fasilitas.create') }}" class="btn btn-success"><i class='bx bx-plus-circle'
                ...
                <tbody class="table-border-bottom-0">
                    @foreach ($fasilitas as $index => $item)
                        <tr>
                            ...
                            <td><img src="{{ url('assets/img/fasilitas/' . $item->image) }}" alt="Image-Ekstrakulikuler"
                                    height="100px">
                            </td>
                            <td>{{ $item->nama }}</td>
