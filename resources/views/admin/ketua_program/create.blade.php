...
@section('content')
    ...
    <div class="card mb-5">
        ...
        <div class="table-responsive text-nowrap">
            <div class="row">
                <form class="needs-validation forms-sample" method="POST" action="{{ route('admin-ketua-program.store') }}"
                    ...
                    <div class="col-lg-6 offset-2 col-md-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" id="profil" name="profil" class="form-control"
                                aria-describedby="helpId" required>
                            <div>
                                <img id="showImage" src="{{ url('assets/img/program/home-program-1.jpg') }}"
