        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-4 text-end mb-3">
                    <a href="{{ route('admin-berita.create') }}" class="btn btn-success"><i class='bx bx-plus-circle'
                ...
                <tbody class="table-border-bottom-0">
                    @foreach ($berita as $index => $item)
                        <tr>
                            ...
                            <td><img src="{{ url('assets/img/blog/' . $item->foto) }}" alt="Image-Berita" height="100px">
                            </td>
                            <td>{{ $item->judul }}</td>
                            <td>{{ $item->penulis }}</td>
                            <td>{!! $item->isi !!}</td>
